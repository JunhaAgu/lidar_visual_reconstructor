...
void callbackToExcavator(const tutorial_rosardu_customtopic::packetsToExcavator &msg_from_mpc) {
  start = micros();
...
// subscriber
ros::Subscriber<tutorial_rosardu_customtopic::packetsToExcavator> sub_msg("/mpc/msg", callbackToExcavator);
